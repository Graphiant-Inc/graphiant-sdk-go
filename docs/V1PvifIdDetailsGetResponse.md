...
### NewV1PvifIdDetailsGetResponse

`func NewV1PvifIdDetailsGetResponse() *V1PvifIdDetailsGetResponse`

NewV1PvifIdDetailsGetResponse instantiates a new V1PvifIdDetailsGetResponse object
This constructor will assign default values to properties that have it defined,
and makes sure properties required by API are set, but the set of arguments
will change when the set of required properties is changed

### NewV1PvifIdDetailsGetResponseWithDefaults

`func NewV1PvifIdDetailsGetResponseWithDefaults() *V1PvifIdDetailsGetResponse`

NewV1PvifIdDetailsGetResponseWithDefaults instantiates a new V1PvifIdDetailsGetResponse object
This constructor will only assign default values to properties that have it defined,
but it doesn't guarantee that properties required by API are set

### GetAdvertiseAllSites

`func (o *V1PvifIdDetailsGetResponse) GetAdvertiseAllSites() bool`

GetAdvertiseAllSites returns the AdvertiseAllSites field if non-nil, zero value otherwise.

### GetAdvertiseAllSitesOk

`func (o *V1PvifIdDetailsGetResponse) GetAdvertiseAllSitesOk() (*bool, bool)`
...
`func (o *V1PvifIdDetailsGetResponse) SetAdvertiseAllSites(v bool)`

SetAdvertiseAllSites sets AdvertiseAllSites field to given value.

### HasAdvertiseAllSites

`func (o *V1PvifIdDetailsGetResponse) HasAdvertiseAllSites() bool`

HasAdvertiseAllSites returns a boolean if a field has been set.

### GetAdvertisement

`func (o *V1PvifIdDetailsGetResponse) GetAdvertisement() ManaV2SiteInformation`

GetAdvertisement returns the Advertisement field if non-nil, zero value otherwise.

### GetAdvertisementOk

`func (o *V1PvifIdDetailsGetResponse) GetAdvertisementOk() (*ManaV2SiteInformation, bool)`
...
`func (o *V1PvifIdDetailsGetResponse) SetAdvertisement(v ManaV2SiteInformation)`

SetAdvertisement sets Advertisement field to given value.

### HasAdvertisement

`func (o *V1PvifIdDetailsGetResponse) HasAdvertisement() bool`

HasAdvertisement returns a boolean if a field has been set.

### GetConsumerLanSegments

`func (o *V1PvifIdDetailsGetResponse) GetConsumerLanSegments() map[string]ManaV2PublicVifGatewayConsumerLanDevices`

GetConsumerLanSegments returns the ConsumerLanSegments field if non-nil, zero value otherwise.

### GetConsumerLanSegmentsOk

`func (o *V1PvifIdDetailsGetResponse) GetConsumerLanSegmentsOk() (*map[string]ManaV2PublicVifGatewayConsumerLanDevices, bool)`
...
`func (o *V1PvifIdDetailsGetResponse) SetConsumerLanSegments(v map[string]ManaV2PublicVifGatewayConsumerLanDevices)`

SetConsumerLanSegments sets ConsumerLanSegments field to given value.

### HasConsumerLanSegments

`func (o *V1PvifIdDetailsGetResponse) HasConsumerLanSegments() bool`

HasConsumerLanSegments returns a boolean if a field has been set.

### GetCoveringPrefixes

`func (o *V1PvifIdDetailsGetResponse) GetCoveringPrefixes() []string`

GetCoveringPrefixes returns the CoveringPrefixes field if non-nil, zero value otherwise.

### GetCoveringPrefixesOk

`func (o *V1PvifIdDetailsGetResponse) GetCoveringPrefixesOk() (*[]string, bool)`
...
`func (o *V1PvifIdDetailsGetResponse) SetCoveringPrefixes(v []string)`

SetCoveringPrefixes sets CoveringPrefixes field to given value.

### HasCoveringPrefixes

`func (o *V1PvifIdDetailsGetResponse) HasCoveringPrefixes() bool`

HasCoveringPrefixes returns a boolean if a field has been set.

### GetGatewayBgpNeighbors

`func (o *V1PvifIdDetailsGetResponse) GetGatewayBgpNeighbors() map[string]ManaV2BgpNeighbor`

GetGatewayBgpNeighbors returns the GatewayBgpNeighbors field if non-nil, zero value otherwise.

### GetGatewayBgpNeighborsOk

`func (o *V1PvifIdDetailsGetResponse) GetGatewayBgpNeighborsOk() (*map[string]ManaV2BgpNeighbor, bool)`
...
`func (o *V1PvifIdDetailsGetResponse) SetGatewayBgpNeighbors(v map[string]ManaV2BgpNeighbor)`

SetGatewayBgpNeighbors sets GatewayBgpNeighbors field to given value.

### HasGatewayBgpNeighbors

`func (o *V1PvifIdDetailsGetResponse) HasGatewayBgpNeighbors() bool`

HasGatewayBgpNeighbors returns a boolean if a field has been set.

### GetId

`func (o *V1PvifIdDetailsGetResponse) GetId() int64`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *V1PvifIdDetailsGetResponse) GetIdOk() (*int64, bool)`
...
`func (o *V1PvifIdDetailsGetResponse) SetId(v int64)`

SetId sets Id field to given value.

### HasId

`func (o *V1PvifIdDetailsGetResponse) HasId() bool`

HasId returns a boolean if a field has been set.

### GetLanSegmentId

`func (o *V1PvifIdDetailsGetResponse) GetLanSegmentId() int64`

GetLanSegmentId returns the LanSegmentId field if non-nil, zero value otherwise.

### GetLanSegmentIdOk

`func (o *V1PvifIdDetailsGetResponse) GetLanSegmentIdOk() (*int64, bool)`
...
`func (o *V1PvifIdDetailsGetResponse) SetLanSegmentId(v int64)`

SetLanSegmentId sets LanSegmentId field to given value.

### HasLanSegmentId

`func (o *V1PvifIdDetailsGetResponse) HasLanSegmentId() bool`

HasLanSegmentId returns a boolean if a field has been set.

### GetNatPrefixStrategy

`func (o *V1PvifIdDetailsGetResponse) GetNatPrefixStrategy() ManaV2PublicVifGatewayNatPrefixStrategy`

GetNatPrefixStrategy returns the NatPrefixStrategy field if non-nil, zero value otherwise.

### GetNatPrefixStrategyOk

`func (o *V1PvifIdDetailsGetResponse) GetNatPrefixStrategyOk() (*ManaV2PublicVifGatewayNatPrefixStrategy, bool)`
...
`func (o *V1PvifIdDetailsGetResponse) SetNatPrefixStrategy(v ManaV2PublicVifGatewayNatPrefixStrategy)`

SetNatPrefixStrategy sets NatPrefixStrategy field to given value.

### HasNatPrefixStrategy

`func (o *V1PvifIdDetailsGetResponse) HasNatPrefixStrategy() bool`

HasNatPrefixStrategy returns a boolean if a field has been set.

### GetRegionId

`func (o *V1PvifIdDetailsGetResponse) GetRegionId() int32`

GetRegionId returns the RegionId field if non-nil, zero value otherwise.

### GetRegionIdOk

`func (o *V1PvifIdDetailsGetResponse) GetRegionIdOk() (*int32, bool)`
...
`func (o *V1PvifIdDetailsGetResponse) SetRegionId(v int32)`

SetRegionId sets RegionId field to given value.

### HasRegionId

`func (o *V1PvifIdDetailsGetResponse) HasRegionId() bool`

HasRegionId returns a boolean if a field has been set.

### GetServiceName

`func (o *V1PvifIdDetailsGetResponse) GetServiceName() string`

GetServiceName returns the ServiceName field if non-nil, zero value otherwise.

### GetServiceNameOk

`func (o *V1PvifIdDetailsGetResponse) GetServiceNameOk() (*string, bool)`
...
`func (o *V1PvifIdDetailsGetResponse) SetServiceName(v string)`

SetServiceName sets ServiceName field to given value.

### HasServiceName

`func (o *V1PvifIdDetailsGetResponse) HasServiceName() bool`

HasServiceName returns a boolean if a field has been set.

### GetStorageProvider

`func (o *V1PvifIdDetailsGetResponse) GetStorageProvider() string`

GetStorageProvider returns the StorageProvider field if non-nil, zero value otherwise.

### GetStorageProviderOk

`func (o *V1PvifIdDetailsGetResponse) GetStorageProviderOk() (*string, bool)`
...
`func (o *V1PvifIdDetailsGetResponse) SetStorageProvider(v string)`

SetStorageProvider sets StorageProvider field to given value.

### HasStorageProvider

`func (o *V1PvifIdDetailsGetResponse) HasStorageProvider() bool`
