...
// checks if the V1ExtranetB2bConsumersCustomerIdGetResponseIpsecVpnTunnelConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1ExtranetB2bConsumersCustomerIdGetResponseIpsecVpnTunnelConfig{}

// V1ExtranetB2bConsumersCustomerIdGetResponseIpsecVpnTunnelConfig struct for V1ExtranetB2bConsumersCustomerIdGetResponseIpsecVpnTunnelConfig
type V1ExtranetB2bConsumersCustomerIdGetResponseIpsecVpnTunnelConfig struct {
...
func NewV1ExtranetB2bConsumersCustomerIdGetResponseIpsecVpnTunnelConfig() *V1ExtranetB2bConsumersCustomerIdGetResponseIpsecVpnTunnelConfig {
	this := V1ExtranetB2bConsumersCustomerIdGetResponseIpsecVpnTunnelConfig{}
	return &this
}
...
func (o V1ExtranetB2bConsumersCustomerIdGetResponseIpsecVpnTunnelConfig) MarshalJSON() ([]byte, error) {
...
func (o V1ExtranetB2bConsumersCustomerIdGetResponseIpsecVpnTunnelConfig) ToMap() (map[string]interface{}, error) {
...
type NullableV1ExtranetB2bConsumersCustomerIdGetResponseIpsecVpnTunnelConfig struct {
	value *V1ExtranetB2bConsumersCustomerIdGetResponseIpsecVpnTunnelConfig
	isSet bool
}

func (v NullableV1ExtranetB2bConsumersCustomerIdGetResponseIpsecVpnTunnelConfig) Get() *V1ExtranetB2bConsumersCustomerIdGetResponseIpsecVpnTunnelConfig {
	return v.value
}

func (v *NullableV1ExtranetB2bConsumersCustomerIdGetResponseIpsecVpnTunnelConfig) Set(val *V1ExtranetB2bConsumersCustomerIdGetResponseIpsecVpnTunnelConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableV1ExtranetB2bConsumersCustomerIdGetResponseIpsecVpnTunnelConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableV1ExtranetB2bConsumersCustomerIdGetResponseIpsecVpnTunnelConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV1ExtranetB2bConsumersCustomerIdGetResponseIpsecVpnTunnelConfig(val *V1ExtranetB2bConsumersCustomerIdGetResponseIpsecVpnTunnelConfig) *NullableV1ExtranetB2bConsumersCustomerIdGetResponseIpsecVpnTunnelConfig {
	return &NullableV1ExtranetB2bConsumersCustomerIdGetResponseIpsecVpnTunnelConfig{value: val, isSet: true}
}

func (v NullableV1ExtranetB2bConsumersCustomerIdGetResponseIpsecVpnTunnelConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV1ExtranetB2bConsumersCustomerIdGetResponseIpsecVpnTunnelConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
